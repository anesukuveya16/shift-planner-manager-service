...
public class ManagerServiceRestEndpoints {
  ...
  public static final String REJECT_SHIFT_REQUEST = "/shifts/{shiftRequestId}/reject";
  ...
  public static final String REJECT_VACATION_REQUEST = "/vacations/{vacationRequestId}/reject";
